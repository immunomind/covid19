...
- [Single-cell RNA expression profiling of ACE2, the receptor of SARS-CoV-2](https://doi.org/10.1101/2020.01.26.919985)
  ...
  - **Database:** https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE122960
...
- Microsoft and Adaptive Biotechnologies are studying how the human immune system reacts to the coronavirus: MSNBC
  ...
  - **Source type:** Website
  - **Paper DOI:** nan
  - **Article abstract:** Microsoft and Adaptive Biotechnologies are spearheading an effort to understand how the human immune system responds to the virus, and why some people become so critically ill while others are asymptomatic.
