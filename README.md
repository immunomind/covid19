...
| :question: Pending           | scRNAseq + AIRR | <a name="3_short"></a>[Immune cell profiling of COVID-19 patients in the recovery stage by single-cell sequencing](#3_long)                                                                             |
...
| :question: Pending           | scRNAseq + AIRR | <a name="5_short"></a>[Blood single cell immune profiling reveals the interferon-MAPK pathway mediated adaptive immune response for COVID-19](#5_long)                                                  |
...
| :heavy_check_mark: Available | AIRR            | <a name="8_short"></a>[Longitudinal high-throughput TCR repertoire profiling reveals the dynamics of T cell memory formation after mild COVID-19 infection](#8_long)                                    |
| :heavy_check_mark: Available | scRNAseq + AIRR | <a name="9_short"></a>[Potent neutralizing antibodies against SARS-CoV-2 identified by high-throughput single-cell sequencing of convalescent patients’ B cells](#9_long)                               |
| :question: Pending           | scRNAseq        | <a name="10_short"></a>[Single-cell longitudinal analysis of SARS-CoV-2 infection in human bronchial epithelial cells](#10_long)                                                                        |
| Upon request                 | scRNAseq + AIRR | <a name="11_short"></a>[Tocilizumab treatment in severe COVID-19 patients attenuates the inflammatory storm incited by monocyte centric immune interactions revealed by single-cell analysis](#11_long) |
| :heavy_check_mark: Available | scRNAseq + AIRR | <a name="12_short"></a>[A molecular cell atlas of the human lung from single cell RNA sequencing](#12_long)                                                                                             |
| :heavy_check_mark: Available | scRNAseq        | <a name="13_short"></a>[Bulk and single-cell gene expression profiling of SARS-CoV-2 infected human cell lines identifies molecular targets for therapeutic intervention](#13_long)                     |
| :heavy_check_mark: Available | AIRR            | <a name="14_short"></a>[Immunologic perturbations in severe COVID-19/SARS-CoV-2 infection](#14_long)                                                                                                    |
| :heavy_check_mark: Available | scRNAseq        | <a name="15_short"></a>[Identification of Candidate COVID-19 Therapeutics using hPSC-derived Lung Organoids](#15_long)                                                                                  |
...
- <a name="8_long"></a>[:arrow_left: Back to table](#8_short)
...
- <a name="9_long"></a>[:arrow_left: Back to table](#9_short)
...
- <a name="10_long"></a>[:arrow_left: Back to table](#10_short)
...
- <a name="11_long"></a>[:arrow_left: Back to table](#11_short)
...
- <a name="12_long"></a>[:arrow_left: Back to table](#12_short)
...
- <a name="13_long"></a>[:arrow_left: Back to table](#13_short)
...
- <a name="14_long"></a>[:arrow_left: Back to table](#14_short)
...
- <a name="15_long"></a>[:arrow_left: Back to table](#15_short)
